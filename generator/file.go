...
func ProcessFile(f *descriptor.FileDescriptorProto, packageName, helperPackageName *string, messages MessageOptionList, debug, usePackageInPath bool, paths string) (string, string, error) {
	...
	absPath, content := goFileName(f, pathType, pn)
...
func goFileName(d *descriptor.FileDescriptorProto, pathType PathType, pn string) (string, string) {
	name := d.GetName()
	...
	return name, d.Options.GetGoPackage()
}
